...
tmux send-keys -t $NAME "MKL_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 OMP_NUM_THREADS=1 python -m es_distributed.main workers --master_host 192.168.0.34 --relay_socket_path /tmp/es_redis_relay.sock --algo $ALGO" C-m
